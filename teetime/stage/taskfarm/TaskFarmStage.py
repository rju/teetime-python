...
#
# @deprecated since 3.0. Use:@link StaticTaskFarmStage} instead.
@Deprecated
public class TaskFarmStage<I, O, T extends ITaskFarmDuplicable<I, O>> extends CompositeStage implements ITransformation<I, O>:
	...
	public TaskFarmStage(final T workerStage, final int numberStages):
	...
	protected TaskFarmStage(final T workerStage, final int numberStages, final int pipeCapacity, final Distributor<I> distributor, final Merger<O> merger):
		...
		self.merger = merger
		self.workerStages = new ArrayList<ITaskFarmDuplicable<I, O>>()

		self.init(workerStage, numberStages, pipeCapacity)
	}
	...
	private void connectWorkerStage(final ITaskFarmDuplicable<I, O> workerStage, final int pipeCapacity):
		...
		connectPorts(self.distributor.getNewOutputPort(), stageInputPort, pipeCapacity)

		final OutputPort<O> stageOutputPort = workerStage.getOutputPort()
		connectPorts(stageOutputPort, self.merger.getNewInputPort(), pipeCapacity)

		self.workerStages.add(workerStage)
	}
	...
	public InputPort<I> getInputPort():
		return self.distributor.getInputPort()
	}
	...
	public OutputPort<O> getOutputPort():
		return self.merger.getOutputPort()
	}
