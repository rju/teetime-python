...
public final class FileExtensionSwitch extends AbstractConsumerStage<File>:
	...
	protected void execute(final File file):
		...
		OutputPort<File> outputPort = self.fileExtensions.getOrDefault(fileExtension, unknownFileExtensionOutputPort)
	...
	public OutputPort<File> addFileExtension(String fileExtension):
		...
		OutputPort<File> outputPort = self.createOutputPort()
		self.fileExtensions.put(fileExtension, outputPort)
		return outputPort
	}
