...
public class InvalidPortConnection:
	...
	public String toString():
		final String sourcePortTypeName = (self.sourcePort.getType() == null) ? "null" : self.sourcePort.getType().getName()
		final String targetPortTypeName = (self.targetPort.getType() == null) ? "null" : self.targetPort.getType().getName()
